      ...
      <div className="key-features">
        <div className="feature">
          ...
          <p className="small-paragraph">
            Elevate your vitality and nourish your body with wholesome nutrition - embrace the power of healthy eating
            for a vibrant life.
          </p>
        </div>
        ...
        <div className="feature">
          ...
          <p className="small-paragraph">
            Prioritize your sleep for a brighter tomorrow - adequate rest fuels your productivity, enhances mood, and
            fortifies your overall well-being.
          </p>
        </div>
        <div className="feature">
          ...
          <p className="small-paragraph">
            Stay hydrated and energized with water - the essential elixir for a healthier body and sharper mind.
          </p>
        </div>
      </div>
